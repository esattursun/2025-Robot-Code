...
public class AutoAlignmentReefAlg extends Command {
  ...
  public 
    AutoAlignmentReefAlg(SwerveSubsystem drivebase,double vertical ,double horizontal) {
  ...
  public AutoAlignmentReefAlg(SwerveSubsystem drivebase,double vertical ,double horizontal,Station station) {
    this.drivebase = drivebase; 
    this.vertical = vertical;
    this.horizontal = horizontal;
