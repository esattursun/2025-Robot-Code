...
public class AutoAlignmentReefWithPid extends Command {
  ...
  AutoAlignmentReefWithPid(SwerveSubsystem drivebase,double vertical ,double horizontal) {
  ...
  public AutoAlignmentReefWithPid(SwerveSubsystem drivebase,double vertical ,double horizontal,Station station) {
    this.drivebase = drivebase; 
    this.vertical = vertical;
    this.horizontal = horizontal;
